...
namespace Core.Entity.Common
{
    ...
    public class FileUploadApiMessage : JsonMessage
    {
        ...
        { get { return this._uploadedFilePath; } set { this._uploadedFilePath = value; } }

        /// <summary>
        /// Property will return partial path - eg : /bookcontent/filename.jpg
        /// </summary>
        public string UploadedFilePathVir
        { get { return this._uploadedFilePathVir; } set { this._uploadedFilePathVir = value; } }
    ...
    public class JsonMessageApi
    {
        ...
        public JsonMessageApi(bool isSuccess, object voiceData)
        {
            this.isSuccess = isSuccess;
