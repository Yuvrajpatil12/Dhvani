...
function assignedbibletFilter() {
    ...
    $(".assigned-bib-filter").find("tbody tr td").not($(".assigned-bib-filter").find("tbody tr td.lastTd")).bind("click", function () {
        $(".assigned-bib-filter").find(this).parent().toggleClass("report-toggle-class");
