...
namespace Core.Business.DataAccess.Wrapper
{
    ...
    {
        private readonly string _module = "Core.Business.DataAccess.Wrapper.Roles";
        ...
        public bool Save(ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            try
            {
                ...
                else
                {
                    ...
                    command.AddParameter(RolesDBFields.ID, objWrapperClass.ID, DataAccessLayer.DataAccess.DataType.Number, 0, ParameterDirection.Input);
                    ...
                    command.AddParameter(RolesDBFields.UpdateDate, objWrapperClass.UpdateDate, DataAccessLayer.DataAccess.DataType.DateTime, 0, ParameterDirection.Input);
