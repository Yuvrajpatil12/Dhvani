...
namespace Core.Business.DataAccess.Wrapper
{
    ...
    {
        private readonly string _module = "Core.Business.DataAccess.Wrapper.AccessMember";
        ...
        public bool Save(ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            try
            {
                ...
                else
                {
                    ...
                    command.AddParameter(AccessMemberDBFields.RoleID, objWrapperClass.RoleID, DataAccessLayer.DataAccess.DataType.Varchar2, 0, ParameterDirection.Input);
