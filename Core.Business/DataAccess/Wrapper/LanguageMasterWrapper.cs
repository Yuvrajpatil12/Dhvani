...
namespace Core.Business.DataAccess.Wrapper
{
    ...
    {
        private readonly string _module = "Core.Business.DataAccess.Wrapper.LanguageMaster";
        ...
        public bool Save(ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            try
            {
                ...
                else
                {
                    ...
                    command.AddParameter(LanguageMasterDBFields.LanguageCode, objWrapperClass.LanguageCode, DataAccessLayer.DataAccess.DataType.NVarChar, 0, ParameterDirection.Input);
    ...
    public class LanguageMasterWrapperColletion : UniversalCollection
    {
        ...
        public bool GetRecords(bool createDataSet, string[,] sortFields, bool isParameter, string fieldName, string fieldValue)
        {
            ...
            return GetCollectionForQueryWithParameters(LanguageMasterStoredProcedures.GetLanguageMasterRecordByValue, Fieldsname, Values);
        }
        ...
        private bool GetCollectionForQueryWithParameters(string sqlQuery, string[] fieldNames, string[] values)
        {
            ...
            try
            {
                ...
                while (_Dtr.Read())
                {
                    LanguageMasterDataMapper objDataMapper = new LanguageMasterDataMapper();
