...
namespace Core.Business.BusinessFacade
{
    public class RolesBusinessFacade//:UniversalObject
    {
        ...
        private RolesWrapperColletion objRolesWrapperColletion = new RolesWrapperColletion();
        private RolesWrapper objRolesWrapper = new RolesWrapper();
        private static readonly string _module = "Core.Business.BusinessFacade.RolesBusinessFacade";
